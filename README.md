...
```
cd existing_repo
git remote add origin https://gitlab.com/kamilhumbatov/delivery.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/kamilhumbatov/delivery/-/settings/integrations)
